...
public class ClusterBinaryJedisCommandsTest {
  ...
  protected static final String PASSWORD_10767 = "0b0b363813be884a827682f3657f770a";    //password for redis-cluster 10767


  @Before
  public void setUp() throws InterruptedException {
    node1 = new Jedis(nodeInfo1);
//    node1.auth(PASSWORD_10767);
    node1.flushAll();

    node2 = new Jedis(nodeInfo2);
//    node2.auth(PASSWORD_10767);
    node2.flushAll();

    node3 = new Jedis(nodeInfo3);
//    node3.auth(PASSWORD_10767);
    node3.flushAll();
